...
<template>
  <div :class="item.content.title ? 'custom-containershadow' : 'custom-container'">
    <div class='custom-title' v-if="item.content.title">
      ...
      <img v-if="item.content.subType == 'medicalRecord'" class='tag-pic' src="../../../../assets/images/diagnosis_record.png" mode='aspectFill'/>
      <img v-else-if="item.content.subType == 'prescription'" class='tag-pic' src="../../../../assets/images/prescription_record.png" mode='aspectFill'/>
      <img v-else-if="item.content.subType == 'inspection'" class='tag-pic' src="../../../../assets/images/inspection_record.png" mode='aspectFill'/>
    </div>
