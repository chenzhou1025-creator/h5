        ...
        <li v-for="(message, index) in messages" :key = index>
            ...
            <div class="message-core" v-else>
                ...
                <div class="content" :class="message.isSend ? 'right' : 'left'">
                    ...
                    <div v-else-if="message.type == 'custom'" style="width:100%">
                        <custom :item="message" :index="index" @customClick="customClick" @footClick="footClick"></custom>
                    </div>
                    <!-- <div v-else>{{}}</div> -->
                </div>
...
export default {
    ...
    data: function(){
        return {
            doctorHeadImg: require('../../../assets/images/chat_avatar_doctor.png'),
            patientHeadImg: require('../../../assets/images/chat_avatar_user.png')
